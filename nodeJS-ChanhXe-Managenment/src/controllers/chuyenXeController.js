...
const createTrip = async (req, res) => {
  try {
    const { xe_id, tai_xe_id, tai_xe_phu_id, thoi_gian_xuat_ben, thoi_gian_cap_ben, trang_thai, id_ben_xe_nhan, id_ben_xe_gui } = req.body;
    ...
    const [result] = await pool.query(
      `INSERT INTO chuyen_xe (xe_id, tai_xe_id, tai_xe_phu_id, thoi_gian_xuat_ben, thoi_gian_cap_ben, trang_thai, id_ben_xe_nhan, id_ben_xe_gui, id_nguoi_cap_nhat, ngay_tao, ngay_cap_nhat) 
       VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, NOW(), NOW())`,
      [xe_id, tai_xe_id, tai_xe_phu_id, thoi_gian_xuat_ben, thoi_gian_cap_ben, trang_thai, id_ben_xe_nhan, id_ben_xe_gui, id_nguoi_cap_nhat]
    );
