...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'adbfd8e7-f34e-11ef-8c3c-aeb42a39543a:1-400';
...
INSERT INTO `ben_xe` VALUES (16,'Nguyễn Thiện Thành, Thị trấn An Phú, Huyện An Phú, Tỉnh An Giang','Bến xe Trà Vinh','Tỉnh An Giang','Huyện An Phú','Thị trấn An Phú',13,'2025-02-26 17:41:29','2025-02-26 16:23:00','Nguyễn Thiện Thành'),(17,'Nguyễn Đáng, Thị trấn An Phú, Huyện An Phú, Tỉnh An Giang','Bến xe Tỉnh An Giang','Tỉnh An Giang','Huyện An Phú','Thị trấn An Phú',13,'2025-02-26 17:40:42','2025-02-26 16:57:20','Nguyễn Đáng');
...
CREATE TABLE `chuyen_xe` (
  ...
  `trang_thai` enum('dang_van_chuyen','da_den') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dang_van_chuyen',
  `id_nguoi_cap_nhat` int NOT NULL,
  `ngay_cap_nhat` datetime NOT NULL,
  `ngay_tao` datetime NOT NULL,
...
INSERT INTO `nguoi_dung` VALUES (13,'Phúc','0327434824','hohoangphucjob@gmail.com','$2b$10$N..NEs5ybA5C8W/Q70twhuFkiSUsV.ggxTTCi5xowla.hNZIHmxsW','admin','hoat_dong',0,'2025-02-22 23:11:10','2025-02-22 23:11:10'),(16,'Phúc','0327434821','phucvntv159@gmail.com','$2b$10$QFEKVVzNL5Au3UsMpW6id./wXJzwy/rp0ifPHaXJNjEspLHTGKGJe','nhan_vien_giao_dich','tam_ngung',13,'2025-02-26 17:44:00','2025-02-24 12:40:31'),(17,'Phúc Tài Xế','0327434555','phucvntv1@gmail.com','$2b$10$dykFzs0FhzG3yXxtzS9RTe2PZOzmOZazzNcTJ5Oc8SMwQa3gdDWc6','tai_xe','tam_ngung',13,'2025-02-24 15:54:32','2025-02-24 13:13:19'),(18,'Phúc tài xế phụ ','03274348552','phucvntv2@gmail.com','$2b$10$oNtHdWV7pSlQTYMKoyMb8.g13JbhN/t0dgKXtswab6JkBmkUhtKFK','tai_xe_phu','hoat_dong',13,'2025-02-26 17:42:06','2025-02-24 13:13:52'),(19,'Phúc Quản lý kho','03274348557','phucvntv3@gmail.com','$2b$10$8eOM4NkuP30o9DPGpnYkfe3Nu5iaIr394xVl7CLVxp5RlnGgTdNvO','nhan_vien_kho','hoat_dong',13,'2025-02-26 17:42:09','2025-02-24 13:14:11'),(20,'Phúc điều phối xe','03274348558','phucvntv4@gmail.com','$2b$10$mQ5/ZsTd93IyzxgKlWn.B.wcyb7iVo.H8ozvZm5m6Jvl8GlHdsfxm','nhan_vien_dieu_phoi','hoat_dong',13,'2025-02-26 17:42:19','2025-02-24 13:14:48');
...
CREATE TABLE `xe` (
  ...
  `trang_thai` enum('hoat_dong','bao_tri','ngung_hoat_dong') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'hoat_dong',
  `id_nguoi_cap_nhat` int NOT NULL,
  `ngay_cap_nhat` datetime NOT NULL,
  `ngay_tao` datetime NOT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `xe` VALUES (1,'84-E12A261','Xe tải nhẹ',100.00,'hoat_dong',13,'2025-02-26 16:55:46','2025-02-24 13:48:37');
...
-- Dump completed on 2025-02-27  1:54:15
