...
CREATE TABLE `ben_xe` (
  ...
  CONSTRAINT `rang_buot_dia_chi_ben_xe` FOREIGN KEY (`dia_chi`) REFERENCES `dia_diem` (`id`) ON DELETE CASCADE
...
INSERT INTO `nguoi_dung` VALUES (13,'Phúc','0327434821','hohoangphucjob@gmail.com','$2b$10$N..NEs5ybA5C8W/Q70twhuFkiSUsV.ggxTTCi5xowla.hNZIHmxsW','admin','hoat_dong',0,'2025-02-22 23:11:10','2025-02-22 23:11:10');
...
--
-- Dumping routines for database 'chanh_xe'
--
...
-- Dump completed on 2025-02-22 23:31:32
