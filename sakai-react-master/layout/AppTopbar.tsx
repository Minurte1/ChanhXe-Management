...
const AppTopbar = forwardRef<AppTopbarRef>((props, ref) => {
    ...
    return (
        ...
        {/* Nút user để mở menu */}
            ...
            <button className="p-link layout-menu-button layout-topbar-button" type="button" ref={topbarmenubuttonRef} onClick={handleProfileClick}>   <i className="pi pi-user" /></button>
