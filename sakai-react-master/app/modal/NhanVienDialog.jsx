...
const NhanVienDialog = ({
  ...
  return (
    <Dialog
      visible={visible}
      style={{ width: "450px" }}
      header={isNew ? "Thêm Nhân Viên" : "Chỉnh Sửa Nhân Viên"}
      modal
      className="p-fluid"
      footer={dialogFooter}
      onHide={onHide}
    >
      <div className="p-field">
        ...
        <InputText
          ...
          onChange={(e) => onInputChange(e, "ho_ten")}
        />
      </div>
      <div className="p-field  mt-2">
        ...
        <InputText
          ...
          onChange={(e) => onInputChange(e, "so_dien_thoai")}
        />
      </div>
      <div className="p-field mt-2">
      ...
      <div className="p-field mt-2">
        ...
        <InputText
          ...
          onChange={(e) => onInputChange(e, "mat_khau")}
        />
      </div>
      <div className="p-field mt-2">
        ...
        <Dropdown
          ...
          onChange={(e) => onInputChange(e, "vai_tro")}
